  ...
  return (
    <main className="grid min-h-svh place-items-center px-5 py-16">
      <div className="glass w-full max-w-md rounded-3xl p-8">
        ...
        <h1 className="mt-8 text-3xl font-semibold tracking-tight">Create owner account</h1>
        <p className="mt-2 text-sm text-muted-foreground">
          Sign up to manage visibility for property presentations.
        </p>
        ...
        <p className="mt-6 text-center text-sm text-muted-foreground">
          Already have an account? <Link href="/owner/login" className="text-primary hover:underline">Sign in</Link>
        </p>
      </div>
    </main>
  )
